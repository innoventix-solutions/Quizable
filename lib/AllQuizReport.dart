...
class AllsQuizReport extends StatefulWidget {
  @override
  _AllsQuizReportState createState() => _AllsQuizReportState();
}

class _AllsQuizReportState extends State<AllsQuizReport> {
