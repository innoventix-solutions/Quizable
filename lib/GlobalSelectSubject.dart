...
void main() => runApp(MaterialApp(
  home: Globalselectsubject(),
));
class Globalselectsubject extends StatefulWidget {
  @override
  _GlobalselectsubjectState createState() => _GlobalselectsubjectState();
}
class _GlobalselectsubjectState extends State<Globalselectsubject> {
