...
class _teacheroptionState extends State<teacheroption> {
  ...
  Widget build(BuildContext context) {
    ...
    children: <Widget>[
      Center(
        child: Container(height: 330,width: 320,
                  ...
                  child: Column(
                    children: <Widget>[
                      Center(child: Padding(
                        ...
                        child: Text('Teacher Option',textAlign: TextAlign.center,style: TextStyle(color: Colors.black,fontSize: 20,fontWeight: FontWeight.bold),),
                      )),
                    ...
                    Column(mainAxisAlignment: MainAxisAlignment.center,
                      children: <Widget>[
                        Padding(
                          ...
                          child: Text('As a Teacher, you can join existing classes ',textAlign: TextAlign.center,style: TextStyle(fontWeight: FontWeight.bold,
                              fontSize: 15,color: black)),
                        ),
                          Text('by Teacher Admin invitation, then you can ',style: TextStyle(fontWeight: FontWeight.bold,
                              fontSize: 15,color: black)),
                          Text('add students to the class and set tasks for ',style: TextStyle(fontWeight: FontWeight.bold,
                              fontSize: 15,color: black)),
                          Text('your classroom members.  ',style: TextStyle(fontWeight: FontWeight.bold,
                          fontSize: 15,color: black),),
                      ],
                    ),
                      Padding(
                        ...
                        child: Column(mainAxisAlignment: MainAxisAlignment.center,
                          children: <Widget>[
                            Text('But if you want to create a new class, you',style: TextStyle(
