...
class publishassignments extends StatefulWidget {
  @override
  _publishassignmentsState createState() => _publishassignmentsState();
}

class _publishassignmentsState extends State<publishassignments> {
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Text("Your Assignment, "+ GlobalData.AssignmentTitle + " will be set for students in " +
