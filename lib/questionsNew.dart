        ...
        return Card(
          child: Column(
            children: <Widget>[
              ...
              Text(
                "Enter answer in sequence with underscore '_' in between the words",
                              ...
                              child: Text(
                                "Level " +
                                    ((GlobalData.QuestionNumber /
                                                ...
                                                .floor() +
                                            1)
                                        .toString() //+" of "+GlobalData.QuizLevels,
                                ,
                                style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 15,
                              ...
                              children: <Widget>[
                                ...
                                Text(
                                  SelectedType == "Fill-in the gaps"
                                      ? "Put '_' in place where gap needs to be displayed"
                                      : "",
                                  style: TextStyle(color: Colors.red),
                                ),
                              ],
    ...
    if (QuestionName.text.toString() == "" ||
      ...
      http.post("http://edusupportapp.com/api/create_update_quiz_questions.php",
          body: {
            ...
            "level_no": ((GlobalData.QuestionNumber /
                            int.parse(GlobalData.NosofQuesPerLevel))
                        .floor() +
                    1)
                .toString(),
            "ques_no": ((GlobalData.QuestionNumber %
                        int.parse(GlobalData.NosofQuesPerLevel)) +
                    1)
                .toString(),
          }).then((response) {
