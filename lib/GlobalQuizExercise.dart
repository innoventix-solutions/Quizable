                    ...
                    child: Row(
                      children: <Widget>[
                        Expanded(
                          child: Text(
                            Quizz_List.isNotEmpty
                                ? Quizz_List[0].no_of_levels + " Levels"
                                : "",
                            style: TextStyle(
                                fontSize: 15,
                                fontWeight: FontWeight.bold,
                        ...
                        Expanded(
                          child: Text(
                            Quizz_List.isNotEmpty
                                ? Quizz_List[0].dur_each_level + " Minutes"
                                : "",
                            style: TextStyle(
                                fontSize: 15,
                                fontWeight: FontWeight.bold,
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Text(
                            Quizz_List.isNotEmpty
                                ? Quizz_List[0].closing_date.substring(0, 19)
                                : "",
                            style: TextStyle(
