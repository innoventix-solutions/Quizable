...
class PreviewSpellingQuestionListss extends StatefulWidget {
  @override
  _PreviewSpellingQuestionListssState createState() => _PreviewSpellingQuestionListssState();
}

class _PreviewSpellingQuestionListssState extends State<PreviewSpellingQuestionListss> {
    ...
    return Scaffold(
        appBar: AppBar(title: Text("Questions List"),centerTitle: true,
          ...
          actions: <Widget>[
            GestureDetector(
                onTap: (){
                  Navigator.of(context).pushReplacementNamed('previewspellinglevellist');
