...
class AllsSpellingReport extends StatefulWidget {
  @override
  _AllsSpellingReportState createState() => _AllsSpellingReportState();
}

class _AllsSpellingReportState extends State<AllsSpellingReport> {
