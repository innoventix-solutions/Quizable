    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        ...
        return AlertDialog(
          ...
          content:
              new Text("Are You Sure Want To Delete the selected Teacher?"),
          actions: <Widget>[
        ...
        body: Column(
          children: <Widget>[
                ...
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      padding: const EdgeInsets.only(left: 10, bottom: 3),
                      child: Text(
                        GlobalData.Studentlist.isNotEmpty
                            ? GlobalData.Studentlist[0].username
                            : "",
                        style: TextStyle(
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Created: " + GlobalData.createdclassdate,
                                ...
                                new PopupMenuItem<String>(
                                  child: Row(
                                    children: <Widget>[
                                      ...
                                      Switch(
                                        value: (GlobalData.activeclass.status ==
                                            "active"),
                                        onChanged: (value) {
                                          if (value == true) {
                                ...
                                children: <Widget>[
                                  Stack(
                                    children: <Widget>[
                                      GestureDetector(
                                        onTap: () {
                                          GlobalData.currentteacher =
                                              GlobalData.Studentlist[index];
            ...
            GlobalData.userType == "teacher"
                ...
                : Padding(
                    padding:
                        const EdgeInsets.only(top: 20, bottom: 25, right: 20),
                    child: GestureDetector(
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.end,
                      ...
                      onTap: () {
                        Navigator.of(context).pushNamed('TeacherInviteCode');
                      },
                    ),
                  ),
          ],
