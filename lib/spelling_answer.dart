...
class _spelling_ansState extends State<spelling_ans> {
  ...
  Widget build(BuildContext context) {
    ...
    child: Container(child: Text(/*Quetions[i].question*/"Que",style: TextStyle(fontWeight: FontWeight.bold),)),
    )),
    ],
    ),
    ),
   // AnswerNow(Quetions[i].answer_type,Quetions[i].anwer_options,Quetions[i].Options,Quetions[i].question),
    ...
    Expanded(child: Padding(
    padding: const EdgeInsets.all(8.0),
    child: Container(child: Text(/*Quetions[i].answer_type*/"Question",style: TextStyle(color: Colors.blue,fontWeight: FontWeight.bold),)),
    )),
    Padding(
    padding: const EdgeInsets.all(8.0),
