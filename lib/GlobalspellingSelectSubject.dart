...
void main() => runApp(MaterialApp(
  home: GlobalSpellingsselectsubject(),
));
class GlobalSpellingsselectsubject extends StatefulWidget {
  @override
  _GlobalSpellingsselectsubjectState createState() => _GlobalSpellingsselectsubjectState();
}
class _GlobalSpellingsselectsubjectState extends State<GlobalSpellingsselectsubject> {
