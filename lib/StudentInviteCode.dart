...
class StudentInviteCode extends StatefulWidget {
  @override
  _StudentInviteCodeState createState() => _StudentInviteCodeState();
}

class _StudentInviteCodeState extends State<StudentInviteCode> {
