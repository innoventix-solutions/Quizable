...
class _Edit_QuestionState extends State<Edit_Question> {
  ...
  TextEditingController QuestionName =
      new TextEditingController(text: GlobalData.Current_Que_To_Edit.question);
  TextEditingController Points = new TextEditingController(
      text: GlobalData.Current_Que_To_Edit.point_awarded);
                                              ...
                                              ButtonClick: () {
                                                if (optioncontroller.text !=
                                                    ...
                                                    optioncontroller.text !=
                                                        "") {
                                                  Options.add(Pojo_Answers(
                                                      trueanswer: SelectedType ==
                                                              "Fill-in the gaps"
                                                          ? true
                                                          : Selected,
                                ...
                                itemBuilder: (context, index) {
                                  return Container(
                                    child: Row(
                                      children: <Widget>[
                                        Checkbox(
                                          value: Options[index].trueanswer,
                                          onChanged: (value) {
                                            Options[index].trueanswer = value;
                                            setState(() {});
                                          },
                                        ),
                                        Expanded(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Container(
                          padding: EdgeInsets.all(5),
                          child: Text(
                            "Select Pairs of Matching Terms.",
                            style: TextStyle(
                                color: Colors.black,
                                fontSize: 15,
                                fontWeight: FontWeight.bold),
                ...
                children: <Widget>[
                  Expanded(
                    child: Container(
                        padding: EdgeInsets.all(5),
                        child: Text(
                          "List Options and Select One Answer ",
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 15,
                              fontWeight: FontWeight.bold),
                ...
                children: <Widget>[
                  Expanded(
                    child: Container(
                        padding: EdgeInsets.all(5),
                        child: Text(
                          "List Options and Select Answer(s)",
                          style: TextStyle(
                              color: Colors.black,
                              fontSize: 15,
                              fontWeight: FontWeight.bold),
              ...
              children: <Widget>[
                        ...
                        children: <Widget>[
                          Expanded(
                            child: Container(
                                ...
                                child: Text(
                                  "Question " +
                                      GlobalData.Current_Que_To_Edit.ques_no,
                                  style: TextStyle(
                                      color: Colors.white,
                                      fontSize: 15,
                                      fontWeight: FontWeight.bold),
                          ...
                          Container(
                              ...
                              child: Text(
                                "Level " +
                                    GlobalData.Current_Que_To_Edit.level_no,
                                style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 15,
                                    fontWeight: FontWeight.bold),
                ...
                Row(
                  ...
                  children: <Widget>[
                    Padding(
                      padding:
                          const EdgeInsets.only(left: 20, top: 25, bottom: 40),
                      child: SizedBox(
                        width: 100,
                        child: GradientButtonText(
                          ButtonClick: () {
                            if (SelectedType == "Fill-in the gaps" &&
                                !QuestionName.text.contains('_')) {
...
// user defined function
  ...
  SaveQuizQuestion() async {
    if (QuestionName.text.toString() == "" ||
        Points.text.toString() == "" ||
        SelectedType.toString() == "" ||
        MyQuestionAnswer(SelectedType) == "") {
      //_showDialog();
      CustomShowDialog(context,
          msg: "Some Values are Missing", title: "Value Missing");
    } else {
      print("question " +
